  ...
  return (
    <div style={{ backgroundColor: "white" }}>
      <div className="container" style={{ margin: "auto", maxWidth: "800px" }}>
        ...
        <p className="text-center text-muted" style={{ color: "#6c757d" }}>
        ...
        <form onSubmit={handleSubmit}>
          <div className="row">
            <div className="col-md-6">
              <h5 className="section-title" style={{ fontWeight: 'bold', marginBottom: "1rem" }}>Tell us about your business</h5>
